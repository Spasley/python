...
def test_phones_on_home_page(app):
    ...
    assert record_from_homepage.home == clear(record_from_edit_page.home)
    assert record_from_homepage.work == clear(record_from_edit_page.work)
    assert record_from_homepage.mobile == clear(record_from_edit_page.mobile)
    assert record_from_homepage.phone2 == clear(record_from_edit_page.phone2)
