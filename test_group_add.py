...
class test_group_add(unittest.TestCase):
    ...
    def test_test_group_add(self):
        ...
        if not wd.find_element_by_xpath("//div[@id='content']//select[normalize-space(.)='[none] groupname']//option[1]").is_selected():
            wd.find_element_by_xpath("//div[@id='content']//select[normalize-space(.)='[none] groupname']//option[1]").click()
